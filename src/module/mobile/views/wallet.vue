<template>
  <div class="page-wallet">
    <section class="main-header">
      <h3 class="title">个人中心-钱包功能</h3>
      <div class="desc">包括创建钱包、激活钱包、查询余额。这是业务应用结合区块链的第一步，所有的交易都要有发送方钱包地址和接收方的钱包地址。钱包激活才能使用，要激活钱包，必须向此钱包转入25个以上的知识币（积分）KC，同时消耗0.01个知识币（积分）KC。查询余额不会消耗知识币（积分）KC。</div>
    </section>
